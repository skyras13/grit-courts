...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${siteUrl}/planner`, lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    ...
    { url: `${siteUrl}/epoxy`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${siteUrl}/sports-lines`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${siteUrl}/golf-simulators`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${siteUrl}/referrals`, lastModified: now, changeFrequency: 'monthly', priority: 0.4 },
